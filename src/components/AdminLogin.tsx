...
const AdminLogin: React.FC = () => {
  ...
  const getErrorMessage = (error: string) => {
    if (error.includes('Admin access required')) {
      return 'Only administrators can access this system. Please contact your system administrator if you believe this is an error.';
    }
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden backdrop-blur-sm bg-white/95">
        <div className="bg-gradient-to-r from-indigo-600 to-purple-700 p-8 text-white text-center relative">
          ...
          <div className="relative z-10">
            ...
            <p className="text-indigo-100 font-medium">Administrator Access</p>
        ...
        <div className="bg-gray-50 px-8 py-4 border-t">
          <div className="text-center">
            <p className="text-xs text-gray-600 mb-2">Default Admin Credentials (Development)</p>
            <div className="bg-white rounded-lg p-3 border text-xs">
              <p className="font-mono text-gray-700">Email: admin@lead.com</p>
              <p className="font-mono text-gray-700">Password: AdminPass123!</p>
            </div>
            <p className="text-xs text-red-500 mt-2">Change default credentials in production</p>
          </div>
        </div>
      </div>
    </div>
